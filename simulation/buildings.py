...
RAILYARD_STATS: Dict[int, BuildingLevelStats] = {
    ...
    3: _stats(
        level=3,
        build_cost      = {R.MINERALS: 430, R.POWER: 25},
        production_rate = {R.TRANSFER: 90},
        production_cost = {R.POWER: 10},
        damage_rate     = 0.25,
        repair_cost     = {R.MINERALS: 35, R.POWER: 4},
        repair_rate     = 2.0,
        build_ticks     = 50,
        workforce       = {2: 3, 3: 1},
...
LAB_STATS: Dict[int, LabLevelStats] = {
    ...
    3: _lab(
        level=3,
        build_cost      = {R.MINERALS: 340, R.ORGANICS: 40, R.POWER: 20},
        production_rate = {R.RESEARCH: 25},
        production_cost = {R.POWER: 10},
        damage_rate     = 0.3,
        repair_cost     = {R.MINERALS: 28, R.ORGANICS: 5, R.POWER: 3},
        repair_rate     = 1.5,
        build_ticks     = 50,
        workforce       = {3: 4},
